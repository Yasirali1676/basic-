         ...
         return SingleChildScrollView(
           child: AlertDialog(
             ...
             Padding(
               ...
               child: Text('Add Your Info',style: TextStyle(fontWeight: FontWeight.bold,color:Colors.black,fontSize: 30,fontStyle: FontStyle.italic ),),
             ),
              Padding(
                 ...
                 children: [
                  GestureDetector(
                     ...
                     child: Container(
                       ...
                       child: Center(child: Text('cencle ',style: TextStyle(color: Colors.white,fontSize: 15 ,fontWeight: FontWeight.bold),)),
                     ),
                   ),
                  //
                  SizedBox(width: 10.h,),
...
//   }
  ...
  Widget build(BuildContext context) {
    return Consumer<DialogProvider>(builder: (context,value,child){
      ...
      return Scaffold(
        appBar: AppBar(
        backgroundColor: AppColor.secondryblue,
